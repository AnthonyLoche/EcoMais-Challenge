...
export default function MachineModalLeftPanel({ machine }) {
  ...
  return (
    <div className="w-full shrink-0 border-r border-gray-100 flex flex-col overflow-y-auto
      [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">

      {/* Imagem */}
      <div className="relative bg-gray-50 flex flex-col items-center justify-center h-[50%] shrink-0">
        {image
          ? <img src={image} alt={machine.codigo} className="w-full h-full object-contain p-2" />
